...
%>
%==========================================================================
%> @section classMakeMeshWithCircularInclusion Class description
%==========================================================================
...
%>
%==========================================================================
function [FileNameOut] = MakeMeshWithCircularInclusion(Data,N,DomainLimits,Circle,FolderName,FileName) 
...
[region1] = PolyMesher(@AcousticBackground,N,100);    
P1 = zeros(region1.ne,2);
for ii = 1:region1.ne
    P1(ii,:) = mean(region1.coords_element{ii});
end
...
P2 = zeros(region2.ne,2);
for ii = 1:region2.ne
    P2(ii,:) = mean(region2.coords_element{ii});
end
