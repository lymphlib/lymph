...
%> to generate an cartesian grid of a horizontally partitioned rectangular domain.
%>
...
function [region] = PolyMesher_BiDomainHorCartesian(Domain,NElem,MaxIter,P)
...
while(It<=MaxIter && Err>Tol)
  ...
  P = [Pc(1:2:NElem,:);[Pc(1:2:NElem,1),-Pc(1:2:NElem,2)]];   %Lloyd's update
%   P = Pc; %Lloyd's update
