...
%> @param MeshType                String 'C' for cartesian grid, 'P' for polygonal grid
%>
%> @retval FileNameOut            File name of the *.mat structure
%>                                containing mesh info
%>
%======================================================================
function [FileNameOut] = MakeMeshQuadridomain(Data,N,DomainLimits,FolderName,FileName,MeshType)
...
if (strcmp(MeshType,'P')==1)
    ...
    % polygonal mesh
    [region] = PolyMesher_QuadriDomain(@Rectangle,N,100);
...
elseif (strcmp(MeshType,'C')==1)
    ...
    [region] = PolyMesher_QuadriDomainCartesian(@Rectangle,N,100,P);
    
end

%% Compute the neighbor structure
[region,neighbor] = MakeNeighborQuadridomain(Data,region);
