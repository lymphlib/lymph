...
function [Error] = ComputeErrorsLaplacian(Data, mesh, femregion, U)
...
function [Error] = VolumeErrorAssemblyLaplacian(Data, Error, elem, ie, id, ~, AssembInfo)
        ...
        gradx_uex_loc = Data.gradu_ex{1}(elem.xq,elem.yq);
        grady_uex_loc = Data.gradu_ex{2}(elem.xq,elem.yq);
