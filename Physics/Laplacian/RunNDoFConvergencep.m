...
%> @date 5 June 2026
%> @brief Convergence analysis for the Poisson problem - Comparison of adaptive and uniform refinement strategies for different polynomial degrees.
%>
%==========================================================================
%> @section classRunNDoFConvergencep Class description
%==========================================================================
...
for pp = 1:length(Data.l_val)
    ...
    Data.degree  = Data.l_val(pp);
    Data.maxDegree  = Data.l_val(pp);
    Data.AdaptFunc  = @(tau_r) floor(1 + 2*Data.l_val(pp)/pi* atan(tau_r));
