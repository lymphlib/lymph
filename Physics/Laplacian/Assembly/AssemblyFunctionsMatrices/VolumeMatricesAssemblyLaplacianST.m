%> @file   VolumeMatricesAssemblyLaplacianST.m
%> @author Mattia Corti
%> @date   12 May 2026
...
%>
%==========================================================================
%> @section classVolumeMatricesAssemblyLaplacianST description
%==========================================================================
...
function [Matrices] = VolumeMatricesAssemblyLaplacianST(Data, Matrices, elem, ie, id, nbases, AssembInfo)
