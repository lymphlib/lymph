...
function [Xh, Xexact] = GetSolutionPostProcessing(Data, femregion, neighbor, U)
    ...
    for ie=1:femregion.nel
        ...
        if femregion.tag(ie) == 'L'
            ...
            % Approximated solutions at evaluation points
            uh_loc  = phiq*u_loc;
            ...
            for iedg = 1 : neighbor.nedges(ie)
                ...
                % Approximated solutions at visualization points
