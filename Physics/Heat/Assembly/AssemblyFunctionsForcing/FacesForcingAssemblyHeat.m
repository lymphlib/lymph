%> @file   FacesForcingAssemblyHeat.m
...
%>
%==========================================================================
%> @section classFacesForcingAssemblyHeat Class description
%==========================================================================
...
function [Forcing] = FacesForcingAssemblyHeat(Data, femregion, Forcing, face, AssembInfo)
