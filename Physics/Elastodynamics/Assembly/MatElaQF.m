...
El.V1_loc = zeros(femregion.nbases^2,femregion.nel);
El.V2_loc = zeros(femregion.nbases^2,femregion.nel);
El.V3_loc = zeros(femregion.nbases^2,femregion.nel);
El.V4_loc = zeros(femregion.nbases^2,femregion.nel);

El.M1_P_rho_loc  = zeros(femregion.nbases^2,femregion.nel);
El.MPrjP_1_loc   = zeros(femregion.nbases^2,femregion.nel);
                  
El.D1_loc  = zeros(femregion.nbases^2,femregion.nel);
El.C1_loc  = zeros(femregion.nbases^2,femregion.nel);
...
for ie = 1 : femregion.nel
    ...
    if tag_ie == 'E'
        ...
        El.V1_loc(:,ie) = (par.lam+2*par.mu)*Integral.gradxgradxC + par.mu*Integral.gradygradyC;
        El.V2_loc(:,ie) = par.lam*Integral.gradygradxC + par.mu*Integral.gradxgradyC;
        El.V3_loc(:,ie) = par.lam*Integral.gradxgradyC + par.mu*Integral.gradygradxC;
        El.V4_loc(:,ie) = (par.lam+2*par.mu)*Integral.gradygradyC + par.mu*Integral.gradxgradxC;

        El.M1_P_rho_loc(:,ie) = par.rho_e*Integral.phiphiC;
        El.MPrjP_1_loc(:,ie)  = Integral.phiphiC;

        El.D1_loc(:,ie)  = (2*par.rho_e*par.zeta)*Integral.phiphiC;
        El.C1_loc(:,ie)  = (par.rho_e*par.zeta^2)*Integral.phiphiC;
...
A.V1 = sparse(ii_index_QF,jj_index_QF,El.V1_loc,femregion.ndof,femregion.ndof);
A.V2 = sparse(ii_index_QF,jj_index_QF,El.V2_loc,femregion.ndof,femregion.ndof);
A.V3 = sparse(ii_index_QF,jj_index_QF,El.V3_loc,femregion.ndof,femregion.ndof);
A.V4 = sparse(ii_index_QF,jj_index_QF,El.V4_loc,femregion.ndof,femregion.ndof);

A.M1_P_rho  = sparse(ii_index_QF,jj_index_QF,El.M1_P_rho_loc,femregion.ndof,femregion.ndof);
A.MPrjP_1   = sparse(ii_index_QF,jj_index_QF,El.MPrjP_1_loc,femregion.ndof,femregion.ndof);
                  
A.D1  = sparse(ii_index_QF,jj_index_QF,El.D1_loc,femregion.ndof,femregion.ndof);
A.C1  = sparse(ii_index_QF,jj_index_QF,El.C1_loc,femregion.ndof,femregion.ndof);
