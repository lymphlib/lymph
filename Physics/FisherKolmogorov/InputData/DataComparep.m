%% Convergence test for FK equation - Comparison with the uniform framework
...
Data.meshfileseq     = ["FK_30_el.mat","FK_100_el.mat","FK_300_el.mat","FK_1000_el.mat"]; 
...
Data.l_val         = [3];		        % Polynomial degree
