%> @file   FinalIndicatorFKPP.m
%> @author Mattia Corti, Caterina Leimer Saglio
%> @date   6 February 2026
%> @brief  Final indicator for FKPP equation.
%>
%==========================================================================
%> @section classFinalIndicatorFKPP Class description
%==========================================================================
%> @brief   Final indicator for FKPP equation.
%>
...
function [Indicator] = FinalIndicatorFKPP(Indicator_loc)
