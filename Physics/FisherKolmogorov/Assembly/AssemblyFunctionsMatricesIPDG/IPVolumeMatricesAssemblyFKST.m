%> @file   IPVolumeMatricesAssemblyFKST.m
%> @author Mattia Corti
%> @date   14 April 2026
...
%>
%==========================================================================
%> @section classIPVolumeMatricesAssemblyFKST Class description
%==========================================================================
%> @brief            Assembly of the matrices associated with volume 
%> integrals of bilinear forms for FK problem (subtriangulation implementation).
%>
...
function [Matrices] = IPVolumeMatricesAssemblyFKST(Data, Matrices, elem, ie, id, nbases, AssembInfo)
        ...
        Matrices.M_loc(1:nbases,1:nbases)     = (elem.dx .* alpha .* elem.phiq)' * elem.phiq;
