%> @file  IPFacesMatricesAssemblyFK.m
%> @author Mattia Corti
%> @date   14 April 2026
%> @brief Assembly of the matrices associated with face integrals for FK
%> problem with IPDG dicretization.
%>
%==========================================================================
%> @section classIPFacesMatricesAssemblyFK Class description
%==========================================================================
%> @brief            Assembly of the matrices associated with face 
%> integrals for FK problem with IPDG dicretization.
%>
...
function [Matrices] = IPFacesMatricesAssemblyFK(Data, femregion, Matrices, face, AssembInfo)
