%> @file   FacesForcingAssemblyFK.m
%> @author Mattia Corti
%> @date   14 April 2026
%> @brief Assembly of the Dirichlet BCs face integrals for FK problem.
%>
%==========================================================================
%> @section classFacesForcingAssemblyFK Class description
%==========================================================================
%> @brief            Assembly of the Dirichlet BCs face integrals for FK problem.
%>
...
function [Forcing] = FacesForcingAssemblyFK(Data, femregion, Forcing, face, AssembInfo)
