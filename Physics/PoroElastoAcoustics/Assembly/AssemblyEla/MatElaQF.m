...
%>
%==========================================================================
%> @section classMatElaPEAQF Class description
%==========================================================================
%> @brief Assembly of the matrices for the elastic problem \cite AM2017
%
...
function [Matrices] = MatElaQF(Data, neighbor, femregion)
...
ii_index_QF = zeros(femregion.nbases^2,femregion.nel_e);
jj_index_QF = zeros(femregion.nbases^2,femregion.nel_e);
...
%% Initialization of the matrices
El.V1_loc = zeros(femregion.nbases^2,femregion.nel_e);
El.V2_loc = zeros(femregion.nbases^2,femregion.nel_e);
El.V3_loc = zeros(femregion.nbases^2,femregion.nel_e);
El.V4_loc = zeros(femregion.nbases^2,femregion.nel_e);

El.M1_P_rho_loc  = zeros(femregion.nbases^2,femregion.nel_e);
El.MPrjP_1_loc   = zeros(femregion.nbases^2,femregion.nel_e);
                  
El.D1_loc  = zeros(femregion.nbases^2,femregion.nel_e);
El.C1_loc  = zeros(femregion.nbases^2,femregion.nel_e);
...
for ie = 1 : femregion.nel
    ...
    if tag_ie == 'E'
        ...
        par.rho_e = Data.rho_el{id_ie-id_shift}(0,0);
        par.vs    = Data.vs_el{id_ie-id_shift}(0,0);
        par.vp    = Data.vp_el{id_ie-id_shift}(0,0);
        par.zeta  = Data.zeta{id_ie-id_shift}(0,0);
        par.mu    = Data.mu_el{id_ie-id_shift}(0,0);
        par.lam   = Data.lam_el{id_ie-id_shift}(0,0);
        par.m     = 0;
        par.beta  = 0;
        ...
        El.M1_P_rho_loc(:,ie_sh) = par.rho_e*Integral.phiphiC;
        El.MPrjP_1_loc(:,ie_sh)  = Integral.phiphiC;

        El.D1_loc(:,ie_sh) = (2*par.rho_e.*par.zeta)*Integral.phiphiC;
        El.C1_loc(:,ie_sh) = (par.rho_e.*par.zeta.^2)*Integral.phiphiC;
...
A.V1 = sparse(ii_index_QF,jj_index_QF,El.V1_loc,femregion.ndof_e,femregion.ndof_e);
A.V2 = sparse(ii_index_QF,jj_index_QF,El.V2_loc,femregion.ndof_e,femregion.ndof_e);
A.V3 = sparse(ii_index_QF,jj_index_QF,El.V3_loc,femregion.ndof_e,femregion.ndof_e);
A.V4 = sparse(ii_index_QF,jj_index_QF,El.V4_loc,femregion.ndof_e,femregion.ndof_e);

A.M1_P_rho  = sparse(ii_index_QF,jj_index_QF,El.M1_P_rho_loc,femregion.ndof_e,femregion.ndof_e);
A.MPrjP_1   = sparse(ii_index_QF,jj_index_QF,El.MPrjP_1_loc,femregion.ndof_e,femregion.ndof_e);
                  
A.D1  = sparse(ii_index_QF,jj_index_QF,El.D1_loc,femregion.ndof_e,femregion.ndof_e);
A.C1  = sparse(ii_index_QF,jj_index_QF,El.C1_loc,femregion.ndof_e,femregion.ndof_e);
