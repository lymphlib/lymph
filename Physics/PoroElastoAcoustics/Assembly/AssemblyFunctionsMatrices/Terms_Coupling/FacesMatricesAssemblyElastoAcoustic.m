%> @file   FacesMatricesAssemblyElastoAcoustic.m
%> @author Ilario Mazzieri, Mattia Corti
%> @date   8 May 2026
%> @brief Assembly of the matrices associated with face's integrals for
%> elastodynamics-acoustics coupling.
%>
%==========================================================================
%> @section classFacesMatricesAssemblyElastoAcoustic Class description
%==========================================================================
%> @brief            Assembly of the matrices associated with face's 
%> integrals for elastodynamics-acoustics coupling.
%>
...
function [Matrices] = FacesMatricesAssemblyElastoAcoustic(Data, femregion, Matrices, face, AssembInfo)
