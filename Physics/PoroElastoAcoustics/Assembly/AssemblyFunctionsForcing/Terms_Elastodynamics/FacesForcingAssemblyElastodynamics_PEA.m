%> @file   FacesForcingAssemblyElastodynamics_PEA.m
%> @author Mattia Corti
%> @date   30 May 2026
...
%>
%==========================================================================
%> @section classFacesForcingAssemblyElastodynamics_PEA Class description
%==========================================================================
...
function [Forcing] = FacesForcingAssemblyElastodynamics_PEA(Data, femregion, Forcing, face, AssembInfo)
    ...
    if face.neigh_ie == -1
        ...
        gD1 = Data.DirBCEla{1}(face.xq,face.yq);
        gD2 = Data.DirBCEla{2}(face.xq,face.yq);
