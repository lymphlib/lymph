%> @file   FacesIndicatorsAssemblyFHN.m
%> @author Mattia Corti, Caterina Leimer Saglio
%> @date   11 May 2026
%> @brief Computation of the face indicators for FHN equation.
%>
%==========================================================================
%> @section classFacesIndicatorsAssemblyFHN Class description
%==========================================================================
%> @brief            Computation of the face indicators for FHN equation.
%>
...
%> assembly procedure
%>
%> @retval Indicatore Indicator struct
%                   
%==========================================================================

function [Indicator] = FacesIndicatorsAssemblyFHN(Data, femregion, Indicator, face, AssembInfo)
    ...
    c_h_self  = face.phiedgeq * AssembInfo.u_h(index_self);
    grad_c_h_n_self  =  (face.nx * face.gradedgeqx + face.ny * face.gradedgeqy) * AssembInfo.u_h(index_self);
    grad_c_h_t_self  = (-face.ny * face.gradedgeqx + face.nx * face.gradedgeqy) * AssembInfo.u_h(index_self);

    c_old_self  = face.phiedgeq * AssembInfo.u_old(index_self);
    grad_c_old_n_self  =  (face.nx * face.gradedgeqx + face.ny * face.gradedgeqy) * AssembInfo.u_old(index_self);
    grad_c_old_t_self  = (-face.ny * face.gradedgeqx + face.nx * face.gradedgeqy) * AssembInfo.u_old(index_self);
    ...
    elseif face.neigh_ie > 0
        ...
        c_h_neigh        = face.phiedgeqneigh * AssembInfo.u_h(index_neigh);
        grad_c_h_n_neigh =  (face.nx * face.gradedgeqxneigh + face.ny * face.gradedgeqyneigh) * AssembInfo.u_h(index_neigh);
        grad_c_h_t_neigh = (-face.ny * face.gradedgeqxneigh + face.nx * face.gradedgeqyneigh) * AssembInfo.u_h(index_neigh);

        c_old_neigh        = face.phiedgeqneigh * AssembInfo.u_old(index_neigh);
        grad_c_old_n_neigh =  (face.nx * face.gradedgeqxneigh + face.ny * face.gradedgeqyneigh) * AssembInfo.u_old(index_neigh);
        grad_c_old_t_neigh = (-face.ny * face.gradedgeqxneigh + face.nx * face.gradedgeqyneigh) * AssembInfo.u_old(index_neigh);
